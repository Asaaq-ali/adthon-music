...
async def quotly(client: Client, message: Message):
    ...
    if not message.reply_to_message and not args:
        return await message.edit("**رد على الرسالة**")
    bot = "QuotLyBot"
    if message.reply_to_message:
        await message.edit("`جاري الانشاء . . .`")
        ...
        async for quotly in client.search_messages(bot, limit=1):
            if quotly:
                ...
                return await message.edit("**فشل انشاء صورة**")
...
async def twitt(client: Client, message: Message):
    ...
    if message.reply_to_message:
        await message.edit("`جاري صنع التغريدة...`")
        await client.unblock_user(bot)
        await message.reply_to_message.forward(bot)
        await asyncio.sleep(5)
        async for twitt in client.search_messages(bot, limit=1):
            if twitt:
                ...
                return await message.edit("**فشل إنشاء حالة تويتر**")
