...
async def rmbg_background(c: Client, m: Message):
    ...
    ky = await m.reply("`انتظر..")
    photo_id = m.reply_to_message.photo.file_id
    if not (reply and (reply.media)):
      return await m.edit("`رد على الصورة...`")
...
add_command_help(
    "التحويل",
    [
        [f"الخلفية [الرد على الصورة]", "لإزالة الخلفية من الصورة."],
        [f"رسوم <بالرد على الصورة>", "تحويل الصور إلى رسوم متحركة باستخدام ai bot"],
        [f"ملصق <بالرد على  الستيكر>", "تحويل الملصق إلى صورة.."],
        [f"ناري [بالرد على الصور]", "لتجميل الصورة باستخدام ناري ديباي.."],
        [f"ابيوس [بالرد على الصور]", "لعمل صورة بالأبيض والأسود."],
        [f"وجه [بالرد على الصور]", "لاخراج الوجه من الصور."],
    ],
)
