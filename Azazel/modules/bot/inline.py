...
from Azazel import CMD_HELP, StartTime, app, ids, cmds
...
BLACK = [1729700147, 6107834238]


def support():
    buttons = [
        [
            InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/adthon_spp"),
        ],
        [
