...
def restart():
    os.execvp(sys.executable, [sys.executable, "-m", "adthon"])
...
💡 Jika ingin membuat bot premium . Kamu bisa hubungin admin dibawah ini membuat bot.</b>""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(text="👮‍♂ Admin 1", url=f"https://t.me/b_idu"),
                    InlineKeyboardButton(text="👮‍♂ Admin 2", url=f"https://t.me/Shoto1916"),
                ],
                  [
