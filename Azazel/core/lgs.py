...
# source : https://github.com/AnonymousX1025/FallenRobot/blob/master/FallenRobot/modules/logo.py
...
async def logo_write(client, message):
    ...
    pro = await message.reply_text("`تتم المعالجة...`")
    ...
    try:
        ...
        font = ImageFont.truetype(randf, fnt_size)
        ...
        await client.send_photo(
            ...
            caption=f"Created By {client.me.mention}",
